...
def main():
    ...
    train_file = os.path.join(args.data_dir, "conllpp_train.txt")
    dev_file = os.path.join(args.data_dir, "conllpp_dev.txt")
    test_file = os.path.join(args.data_dir, "conllpp_test.txt")
    testre_file = os.path.join(args.data_dir, "conllpp_test_rev.txt")
