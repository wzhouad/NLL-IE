...
def main():
    ...
    train_file = os.path.join(args.data_dir, "eng.train")
    dev_file = os.path.join(args.data_dir, "eng.testa")
    test_file = os.path.join(args.data_dir, "eng.testb")
    testre_file = os.path.join(args.data_dir, "eng.testc")
